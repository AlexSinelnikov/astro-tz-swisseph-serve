...
import os, sys, time, zipfile, shutil, argparse, glob, tempfile, hashlib, random
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            if expected_sha:
                ...
                if got.lower() != expected_sha.lower():
                    ...
                    if not allow_missing: sys.exit(5)
            ...
            if prev_sha and prev_sha == cur_sha:
                log("Архив не менялся (sha256 совпал) — распаковка пропущена.")
            else:
